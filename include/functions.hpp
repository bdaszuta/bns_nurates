...
// Combined evaluation of FDI orders 3, 4, 5 at the same argument.
// Shares exp() and branch variables across all three orders.
// Expression trees are identical to the standalone FDI_p3/p4/p5 functions.
KOKKOS_INLINE_FUNCTION
void FDI_p345(const BS_REAL y, BS_REAL* fd3, BS_REAL* fd4, BS_REAL* fd5)
{
    BS_REAL x, ex, t, s, y2;
    BS_REAL r3 = 0., r4 = 0., r5 = 0.;

    x = -fabs(y);

    constexpr BS_REAL A3[8]  = {6,
                                5121.6401850302408,
                                664.28706260743472,
                                19.0856927562699544,
                                0.0410982603688952131,
                                ...
                                2136.54222460571183,
                                92.376788603062645};
    constexpr BS_REAL B3[15] = {
        7881.24597452900838, 4323.07526636309661, 1260.13125873282465,
        653.359212389160499, 354.630774329461644, 113.373708671587772,
        19.9559488532742796, 1.59407954898394322, 2570.7250703533430,
        2972.7443644211129,  2393.9995533270879,  1259.0724833462608,
        459.86413596901097,  112.60906419590854,  16.468882811659000};
    constexpr BS_REAL C3[3] = {11.3643939539669510, 4.93480220054467931, 0.25};

    constexpr BS_REAL A4[8]  = {24,
                                18247.2542465629199,
                                2120.56302902849207,
                                54.659507299984584,
                                0.121876197098273914,
                                ...
                                3261.01909656925521,
                                117.071576489684022};
    constexpr BS_REAL B4[15] = {
        33093.9102025608137, 19031.4783357798975, 5431.08357152245897,
        2393.94262931609398, 1268.40017257978070, 418.662172475927160,
        77.4108960876508190, 6.67374311450268357, 2645.4885670047153,
        3236.2237702166948,  2500.5977847175497,  1278.0109577275445,
        448.99020896813485,  105.86020755838874,  15.216887271751039};
    constexpr BS_REAL C4[3] = {45.4575758158678040, 6.57973626739290575, 0.2};

    constexpr BS_REAL A5[8]  = {120,
                                81190.938912603315,
                                8368.4990332049831,
                                190.753830813273698,
                                0.413800735538960261,
                                ...
                                4977.68099709243407,
                                148.484432990224213};
    constexpr BS_REAL B5[15] = {
        159651.547840031111, 96307.2005742063042, 26923.5693307648389,
        9274.54751848368696, 4445.76333033698006, 1461.45267097859337,
        272.164427980501432, 23.6526046298891619, 2522.7839609396783,
        3244.5527999477567,  2403.0532924519756,  1176.7202478443275,
        397.7596246691212,   91.84661231161838,   13.491911254479298};
    constexpr BS_REAL C5[4] = {236.532261911384425, 113.643939539669510,
                               8.22467033424113218, 0.166666666666666667};
    ...
    if (x < -two)
    {
        ...
        // Identical expression trees to standalone FDI_p3/p4/p5
        r3 =
            ex * (A3[0] - ex * (A3[1] + t * (A3[2] + t * (A3[3] + t * A3[4]))) /
                              (A3[5] + t * (A3[6] + t * (A3[7] + t))));
        r4 =
            ex * (A4[0] - ex * (A4[1] + t * (A4[2] + t * (A4[3] + t * A4[4]))) /
                              (A4[5] + t * (A4[6] + t * (A4[7] + t))));
        r5 =
            ex * (A5[0] - ex * (A5[1] + t * (A5[2] + t * (A5[3] + t * A5[4]))) /
                              (A5[5] + t * (A5[6] + t * (A5[7] + t))));
    }
    else if (x <= zero)
    {
        s = -half * x;
        ...
        r3 = (B3[0] +
              t * (B3[1] +
                   t * (B3[2] +
                        t * (B3[3] +
                             t * (B3[4] +
                                  t * (B3[5] + t * (B3[6] + t * B3[7]))))))) /
             (B3[8] +
              s * (B3[9] +
                   s * (B3[10] +
                        s * (B3[11] +
                             s * (B3[12] + s * (B3[13] + s * (B3[14] + s)))))));
        ...
        r4 = (B4[0] +
              t * (B4[1] +
                   t * (B4[2] +
                        t * (B4[3] +
                             t * (B4[4] +
                                  t * (B4[5] + t * (B4[6] + t * B4[7]))))))) /
             (B4[8] +
              s * (B4[9] +
                   s * (B4[10] +
                        s * (B4[11] +
                             s * (B4[12] + s * (B4[13] + s * (B4[14] + s)))))));
        ...
        r5 = (B5[0] +
              t * (B5[1] +
                   t * (B5[2] +
                        t * (B5[3] +
                             t * (B5[4] +
                                  t * (B5[5] + t * (B5[6] + t * B5[7]))))))) /
             (B5[8] +
              s * (B5[9] +
                   s * (B5[10] +
                        s * (B5[11] +
                             s * (B5[12] + s * (B5[13] + s * (B5[14] + s)))))));
    }
    if (y > zero)
    {
        y2 = y * y;
        r3 = -r3 + C3[0] + y2 * (C3[1] + y2 * C3[2]);
        r4 = r4 + y * (C4[0] + y2 * (C4[1] + y2 * C4[2]));
        r5 = -r5 + C5[0] + y2 * (C5[1] + y2 * (C5[2] + y2 * C5[3]));
    }
...
// Combined evaluation of FDI orders 1, 2, 3, 4, 5 at the same argument.
// Shares exp() and branch variables across all five orders.
// Expression trees are identical to the standalone FDI_p1..p5 functions.
KOKKOS_INLINE_FUNCTION
void FDI_p12345(const BS_REAL y, BS_REAL* fd1, BS_REAL* fd2, BS_REAL* fd3,
                BS_REAL* fd4, BS_REAL* fd5)
{
    BS_REAL x, ex, t, s, y2;
    BS_REAL r1 = 0., r2 = 0., r3 = 0., r4 = 0., r5 = 0.;

    x = -fabs(y);

    // FDI_p1 coefficients (degree 4/4 in exp branch, 9/8 in middle)
    constexpr BS_REAL A1[10] = {1,
                                22189.1070807945062,
                                4915.92700908746777,
                                322.901386168881348,
                                5.9897442965804548,
    ...
    constexpr BS_REAL B1[17] = {
        ...
        27.2746245830016,     -61.57766112137513,    -53.72117554363975,
        -25.678454878692950,  -7.1995819520154718};
    constexpr BS_REAL C1[2] = {1.64493406684822644, 0.5};

    // FDI_p2 coefficients (degree 3/3 in exp branch, 9/8 in middle)
    constexpr BS_REAL A2[8]  = {2,
                                1914.06748184935743,
                                273.085756700981399,
                                8.5861610217850095,
                                0.0161890243763741414,
    ...
    constexpr BS_REAL B2[17] = {
        ...
        1428.0589853413436,   531.62378035996132,   122.54595216479181,
        8.395768655115050,    -3.9142702096919080};
    constexpr BS_REAL C2[2] = {3.28986813369645287, 0.333333333333333333};

    // FDI_p3 coefficients (degree 3/3 in exp branch, 8/7 in middle)
    constexpr BS_REAL A3[8]  = {6,
                                5121.6401850302408,
                                664.28706260743472,
                                19.0856927562699544,
    ...
    if (x < -two)
    {
        ...
        // p1: degree 4/4 (identical to standalone FDI_p1)
        r1 =
            ex *
            (A1[0] -
             ex *
                 (A1[1] + t * (A1[2] + t * (A1[3] + t * (A1[4] + t * A1[5])))) /
                 (A1[6] + t * (A1[7] + t * (A1[8] + t * (A1[9] + t)))));
        // p2-p5: degree 3/3 (identical to standalone FDI_p2..p5)
        r2 =
            ex * (A2[0] - ex * (A2[1] + t * (A2[2] + t * (A2[3] + t * A2[4]))) /
                              (A2[5] + t * (A2[6] + t * (A2[7] + t))));
        r3 =
            ex * (A3[0] - ex * (A3[1] + t * (A3[2] + t * (A3[3] + t * A3[4]))) /
                              (A3[5] + t * (A3[6] + t * (A3[7] + t))));
        r4 =
